<?php $__env->startSection('title','Halaman Tidak Ditemukan — SIBI'); ?>
...
<div class="err-wrap">
    ...
    <div class="err-btns">
        <a href="<?php echo e(route('home')); ?>" class="btn btn-green" style="padding:12px 24px;font-size:14px">
            <i class="fas fa-home" style="font-size:11px"></i> Kembali ke Beranda
        </a>
        <a href="<?php echo e(route('modul.show','angka')); ?>" class="btn" style="padding:12px 22px;font-size:14px">
            🔢 Mulai Belajar
        </a>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\final\resources\views/errors/404.blade.php ENDPATH**/ ?>