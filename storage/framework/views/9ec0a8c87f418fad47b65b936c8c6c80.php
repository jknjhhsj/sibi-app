<?php $__env->startSection('title','Tambah Soal Kuis'); ?>
<?php $__env->startSection('page-title','Tambah Soal Kuis'); ?>
<?php $__env->startSection('page-subtitle','Buat soal baru untuk bank kuis'); ?>
    ...
    <div class="adm-card">
        <div style="padding:16px 20px;border-bottom:1px solid var(--border);display:flex;align-items:center;gap:10px">
            <div style="width:36px;height:36px;background:var(--yellow-light);border-radius:10px;display:flex;align-items:center;justify-content:center">
                <i class="fas fa-plus" style="color:var(--yellow);font-size:14px"></i>
            </div>
            <div>
                <div style="font-family:'Outfit',sans-serif;font-size:14px;font-weight:700;color:var(--text)">Form Tambah Soal</div>
                <div style="font-size:11px;color:var(--text3)">Isi semua kolom yang bertanda * (wajib diisi)</div>
            </div>
        </div>

        <div style="padding:24px">
            <form method="POST" action="<?php echo e(route('admin.kuis.store')); ?>">
                <?php echo csrf_field(); ?>
                <?php echo $__env->make('admin.kuis._form', ['soal' => null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\final-fixed\resources\views/admin/kuis/create.blade.php ENDPATH**/ ?>