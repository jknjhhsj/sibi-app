...
<div style="max-width:720px">
    ...
    <div style="display:flex;align-items:center;gap:8px;font-size:12px;color:var(--text3);margin-bottom:20px">
        ...
        <span>Edit — <?php echo e($konten->judul); ?></span>
    </div>
            ...
            <div style="display:flex;align-items:center;gap:10px">
                ...
                <div>
                    <div style="font-family:'Outfit',sans-serif;font-size:14px;font-weight:700;color:var(--text)">
                        Edit: <?php echo e($konten->judul); ?>

                    </div>
                    <div style="font-size:11px;color:var(--text3)">ID #<?php echo e($konten->id); ?> · Dibuat <?php echo e($konten->created_at->format('d M Y')); ?></div>
                </div>
            </div>
        </div>

        <div style="padding:24px">
            <form method="POST" action="<?php echo e(route('admin.konten.update', $konten)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                <?php echo $__env->make('admin.konten._form', ['konten' => $konten], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\final\resources\views/admin/konten/edit.blade.php ENDPATH**/ ?>