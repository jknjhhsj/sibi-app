...
<head>
    ...
    <title><?php echo $__env->yieldContent('title','SIBI — Belajar Bahasa Isyarat'); ?></title>
...
<div class="app">
    ...
    <header class="topbar">
        ...
        <div class="top-actions">
            ...
            <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" class="btn" style="font-size:12px;padding:6px 12px">
    ...
    <aside class="sidebar">
        ...
        ?>
        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$kat, $ico, $nama]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $cnt = \App\Models\KontenSibi::where('kategori',$kat)->count(); ?>
        <a href="<?php echo e(route('modul.show', $kat)); ?>"
           class="nav-item <?php echo e(request('kategori')===$kat ? 'active' : ''); ?>">
            <div class="nav-icon"><?php echo e($ico); ?></div>
            <?php echo e($nama); ?>

            <?php if($cnt): ?><span class="nav-badge"><?php echo e($cnt); ?></span><?php endif; ?>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        <span class="sb-label">Tantangan</span>
        <a href="<?php echo e(route('kuis.index')); ?>" class="nav-item <?php echo e(request()->routeIs('kuis.*') ? 'active' : ''); ?>">
    ...
    <main class="main">
        ...
        <div class="toast-area">
            <div class="toast toast-s" id="ts">
                ...
                <span class="toast-msg"><?php echo e(session('success')); ?></span>
        ...
        <div class="toast-area">
            <div class="toast toast-e" id="te">
                ...
                <span class="toast-msg"><?php echo e(session('error')); ?></span>
                <button class="toast-x" onclick="this.closest('.toast').remove()">&times;</button>
            </div>
        </div>
        <?php endif; ?>
    ...
    <div class="modal-box">
        ...
        <div style="background:var(--red-light);border:1px solid rgba(176,58,46,.2);border-radius:var(--r-sm);padding:10px 13px;margin-bottom:16px">
            ...
            <p style="color:var(--red);font-size:12px;font-weight:500;margin:0 0 2px;display:flex;align-items:center;gap:5px">
                <i class="fas fa-exclamation-circle" style="font-size:10px"></i> <?php echo e($e); ?>
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST">
            ...
            <div style="margin-bottom:12px">
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="admin@slb.id" class="form-input" required>
            </div>
...
<?php if($errors->any()): ?> document.addEventListener('DOMContentLoaded',()=>openAdminModal()); <?php endif; ?>
setTimeout(()=>document.getElementById('ts')?.remove(),4500);
setTimeout(()=>document.getElementById('te')?.remove(),4500);
</script>
</body>
</html>
<?php /**PATH C:\laragon\www\final\resources\views/layouts/app.blade.php ENDPATH**/ ?>