...
<head>
    ...
    <title>@yield('title','Dashboard') — Panel Admin SIBI</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sb-user">
        ...
        <div style="min-width:0">
            <div class="sb-user-name">{{ Str::limit(Auth::user()->name ?? 'Admin', 16) }}</div>
    ...
    <nav class="sb-nav">
        ...
        <a href="{{ route('admin.dashboard') }}" class="sl {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
            <div class="sl-ico"><i class="fas fa-chart-bar"></i></div>
            Dashboard
        </a>

        <span class="sb-cat">Kelola Konten</span>
        <a href="{{ route('admin.konten.index') }}" class="sl {{ request()->routeIs('admin.konten.index') && !request('kategori') ? 'active' : '' }}">
            <div class="sl-ico"><i class="fas fa-layer-group"></i></div>
            Semua Konten
        </a>
        <a href="{{ route('admin.konten.create') }}" class="sl {{ request()->routeIs('admin.konten.create') ? 'active' : '' }}">
            <div class="sl-ico"><i class="fas fa-plus"></i></div>
            Tambah Konten
        </a>

        <span class="sb-cat">Kelola Kuis</span>
        <a href="{{ route('admin.kuis.index') }}" class="sl {{ request()->routeIs('admin.kuis.*') && !request()->routeIs('admin.kuis.create') ? 'active' : '' }}">
            <div class="sl-ico"><i class="fas fa-trophy"></i></div>
            Semua Soal
        </a>
        <a href="{{ route('admin.kuis.create') }}" class="sl {{ request()->routeIs('admin.kuis.create') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.siswa.index') }}" class="sl {{ request()->routeIs('admin.siswa.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('home') }}" target="_blank" class="sl">
...
<div class="adm-main" id="adm-main">
    ...
    <header class="adm-topbar">
        ...
        <div>
            ...
            <div class="adm-topbar-sub">@yield('page-subtitle','Panel Admin SIBI')</div>
        </div>
    ...
    <div style="padding:0 26px">
        ...
        <div class="flash-s fu" style="margin-top:18px">
            ...
            <span style="font-weight:600;color:var(--accent);font-size:13px">{{ session('success') }}</span>
        ...
        <div class="flash-e fu" style="margin-top:18px">
            ...
            <span style="font-weight:600;color:var(--red);font-size:13px">{{ session('error') }}</span>
            <button onclick="this.parentElement.remove()" style="margin-left:auto;background:none;border:none;cursor:pointer;color:var(--text3);font-size:18px;line-height:1">&times;</button>
        </div>
        @endif
    </div>
